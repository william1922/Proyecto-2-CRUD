const productosElctrodomesticosDiv = document.querySelector('#productos-electrodomesticos')
...
productosElectrodomesticos.forEach(element => {
    productosElctrodomesticosDiv.innerHTML += `<div class="card md-3 mx-lg-4  p-lg-0 my-3 shadow" style="max-width: 540px;">
