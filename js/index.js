...
let productosComputacion = listaProductos.filter(producto => producto.categoria == "Computacion");
let productosElectrodomesticos = listaProductos.filter(producto => producto.categoria == "Electrodomesticos");
let productosAireLibre = listaProductos.filter(producto => producto.categoria == "Aire Libre");
...
function cargarProducto() {
    ...
    if (productosComputacion.length <= 0) {
        ...
        for (let i = productosComputacion.length-1; i > (productosComputacion.length-1)-3; i--) {
            const producto = productosComputacion[i];
        ...
        // btn_ver_mas_c.style.display="block";
    ...
    if (productosAireLibre.length <= 0) {
        ...
        for (let i = productosAireLibre.length-1; i > (productosAireLibre.length-1)-3; i--) {
            const producto = productosAireLibre[i];
        ...
        // btn_ver_mas_a.style.display="block";
